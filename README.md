...
## ✨ Features
* **Real-time Cloud Sync**: Powered by Supabase—access your inventory from any device.
...
-- Settings Table (Stores Categories & Project Allocations as JSON)
CREATE TABLE IF NOT EXISTS settings (
  id TEXT PRIMARY KEY, -- e.g., 'categories' or 'project_data'
...
-- ==========================================
-- 3. CREATE POLICIES (Unified for 'anon' role)
-- ==========================================
